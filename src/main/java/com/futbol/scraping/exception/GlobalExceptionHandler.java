...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleNotFound(ResourceNotFoundException ex) {
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(Map.of(ERROR_KEY, ex.getMessage(), "timestamp", LocalDateTime.now().toString()));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleMalformedJson(HttpMessageNotReadableException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(Map.of(ERROR_KEY, "Malformed JSON request", "timestamp", LocalDateTime.now().toString()));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleMethodArgumentTypeMismatch(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(Map.of(ERROR_KEY, "Invalid request parameter or format", "timestamp",
    ...
    public ResponseEntity<Map<String, Object>> handleServletException(ServletException ex) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(Map.of(ERROR_KEY, "Internal server error", "timestamp", LocalDateTime.now().toString()));
    }
